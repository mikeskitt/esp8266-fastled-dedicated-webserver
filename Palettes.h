...
{  CRGB::FairyLight, CRGB::FairyLight, CRGB::FairyLight, CRGB::FairyLight, 
   ...
   QUARTERFAIRY,     QUARTERFAIRY,     CRGB::FairyLight, CRGB::Salmon, 
   CRGB::FairyLight, CRGB::FairyLight, CRGB::FairyLight, CRGB::SandyBrown };
...
// Lemony_p
const TProgmemRGBPalette16 Lemony_p FL_PROGMEM =
...
{  CRGB::DarkOrange, CRGB::DarkOrange, CRGB::Gold, CRGB::Gold, 
   ...
   CRGB::DarkGreen, CRGB::Orange, CRGB::Yellow, CRGB::Yellow, 
